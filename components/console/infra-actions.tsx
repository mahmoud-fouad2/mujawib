...
const INTEGRATION_FIELD: Record<IntegrationAction, { label: string; hint: string }> = {
  ...
  reschedule: {
    label: 'عنوان تعديل موعد الحجز (اختياري)',
    hint: 'يُستخدم فور توفره عند تعديل الموظف الصوتي لموعد حجز قائم — يتطلب أيضًا تفعيل «إلغاء أو تعديل الحجز صوتيًا» لهذا الموظف. تركه فارغًا لا يؤثر على جاهزية الاتصال.',
  },
  message: {
