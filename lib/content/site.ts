...
const ar: Copy = {
  ...
  hero: {
    ...
    recordTitle: 'مكالمة مباشرة',
    recordMeta: 'انتهت بحجز مؤكد',
  },
  proofLabels: {
    calls: 'مكالمة تمت معالجتها',
    bookings: 'موعدًا حُجز تلقائيًا',
    resolved: 'انتهت دون تدخل موظف',
    response: 'متوسط زمن الرد',
  },
  proofNote: 'أرقام فعلية من المنصة — آخر 30 يومًا.',
  trust: {
    label: 'يشتغل اليوم مع',
    caption: 'شركات تعتمد على المكالمة كقناة بيع وخدمة أساسية.',
  },
  demo: {
    label: 'مكالمات حقيقية',
    title: 'اسمع كيف تنتهي المكالمة، لا كيف تبدأ.',
    lead: 'ثلاث مكالمات من قطاعات مختلفة — الحوار كما جرى، والنتيجة كما سُجّلت.',
  },
  can: {
    label: 'الإمكانات',
...
const en: Copy = {
  ...
  hero: {
    ...
    recordTitle: 'Live call',
    recordMeta: 'ended in a confirmed booking',
  },
  proofLabels: {
    calls: 'calls handled',
  ...
  proofNote: 'Live platform figures — last 30 days.',
  trust: {
  ...
  demo: {
    ...
    lead: 'Three calls from different sectors — the conversation as it happened, the outcome as it was recorded.',
  },
  can: {
    label: 'Capabilities',
